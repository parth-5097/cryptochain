...
describe("Transaction", () => {
  ...
  describe("input", () => {
    ...
    it("has a `timesatmp` in the input", () => {
  ...
  describe("update()", () => {
    ...
    describe("and the amount is valid", () => {
      ...
      it("substracts the amount the original sender output amount", () => {
        expect(transaction.outputMap[senderWallet.publicKey]).toEqual(
  ...
  describe("rewardTransaction()", () => {
    ...
    it("creates ones transaction for the mine with the `MINING_REWARD`", () => {
